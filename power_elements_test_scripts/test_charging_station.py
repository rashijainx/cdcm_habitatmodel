...
if __name__ == "__main__":
    ...
    with System(name="system") as system:
        ...
        charging_rate = Variable(name="charging_rate", value=0.05/(24*365))
    ...
    _map = {
        ...
        # Charging Station
        "health": "/system/charging_station/charge_battery",
        "charge_rate": "/system/charging_station/charge_rate",
    ...
    axs[1].plot(data["t"], data["charge_rate"])
    axs[1].set(ylabel="Charge Rate")
