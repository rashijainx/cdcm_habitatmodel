""" Integrated Testing: Sensor

Author:
    Rashi Jain

Date:
    2/13/2024 | Unit testings + Integration
    2/26/2024 | Pep-8
"""
import sys
import datetime
...
if __name__ == "__main__":
    ...
    _map = {
        ...
        # Sensors
        "sensor_health": "/system/sensor/hardware/functionality",
        "sensor_functionality": "/system/sensor/sense_source",
    }
    ...
    axs[0].plot(data["t"], data["sensor_functionality"])
    axs[0].set(ylabel="Functionality", title="sensor")

    axs[1].plot(data["t"], data["sensor_health"])
