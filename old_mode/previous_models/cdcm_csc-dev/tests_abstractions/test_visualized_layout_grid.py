"""Test visualization on a grid for meteorite damage scenarios
...
for i in range(time_steps):
    ...
    model.transition()
    if i % 20 == 0:
        station_grid.plot_grid(i, "figs_grid/")
...
fig2.suptitle("Radiator Panel Cluster")
fig2.tight_layout()
...
fig3.suptitle("System Level Functionalities")
fig3.tight_layout()
