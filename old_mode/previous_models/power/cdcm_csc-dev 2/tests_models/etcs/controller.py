...
Date: 
    9/21/2023
    10/6/2023 - Integrated with Murali's model. 
...
def make_controller(
    ...
    with System(name="controller") as controller:
        ...
        dust = make_maintainable_component(
            name="dust",
            dt=clock.dt,
        ...
        bolts = make_component(name="bolts", nominal_health=1)

        bearing = make_component(name="bearing", nominal_health=1.0)
